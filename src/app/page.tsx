    ...
    <div className="flex flex-col items-center">
      ...
      <div className="max-w-8xl mx-auto min-h-screen pb-6 pt-4 md:px-4 lg:px-10">
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          <div className="overflow-hidden rounded-xl border-2 border-stone-700">
            <Link
              href="/renders"
            ...
            >
              <section className="group absolute inset-0 z-10 opacity-70 transition-all hover:opacity-100 ">
                <div className="flex h-full w-full flex-row bg-stone-950/50 transition-all ">
                  <div className="z-20 flex h-full w-full p-4 ">
                    <p className="grid h-full w-full select-none content-center text-center text-5xl font-bold text-stone-300/90">
                      3D Portfolio
                    </p>
                  </div>
                </div>
