    ...
    <div className="static bottom-0 flex w-full justify-between px-8 pb-4">
      ...
      <div onClick={scrollToTop} className="flex items-end">
        <svg
          ...
          strokeWidth={1.5}
          stroke="currentColor"
          className="h-8 w-8 stroke-brand-600 hover:animate-pulse"
        >
          <path
            strokeLinecap="round"
      ...
      <div className="flex flex-row items-end gap-2 pb-1">
        <Link href="https://www.instagram.com/gamma2dot2/">
          <svg
            className="h-6 w-6 fill-brand-600 stroke-brand-600 stroke-0 hover:animate-pulse"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 16 16"
          >
        ...
        <Link href="https://github.com/Tooboi">
          <svg
            className="h-6 w-6 fill-brand-600 stroke-brand-600 hover:animate-pulse"
            viewBox="0 0 128 128"
          >
            <path
              fillRule="evenodd"
